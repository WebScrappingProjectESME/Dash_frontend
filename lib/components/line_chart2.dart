    ...
    return Stack(
      children: [
        Positioned(
          ...
          right: 0,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.end, // Alignement du texte et des boutons à gauche
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.end, // Alignement du texte et des boutons à gauche
                children: [
                  const Text(
                    'Zoom :',
                    style: TextStyle(
                  ...
                  _buildButton(1, 'Data Set 1'), // Bouton pour le data set 1
                  _buildButton(2, 'Data Set 2'), // Bouton pour le data set 2
                  _buildButton(3, 'Data Set 3'), // Bouton pour le data set 3
                ],
              ),
            ],
          ),
